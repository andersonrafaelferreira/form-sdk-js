...
let content = `
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="phone" placeholder="Seu telefone" name="phone">
    </div>
...
$(document).ready( function(){
  ...
  $('#button').click( function(){
    ...
    let named = $('#app').attr('title');
      ...
      $.ajax({
           type: "POST",
           url: "https://solucaodigital.site/form/sdk/sender.php", /* endereço do phpmailer */
           async: true,
           data: urlData,
